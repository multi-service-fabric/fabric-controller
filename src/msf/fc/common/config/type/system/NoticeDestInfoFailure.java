...
public class NoticeDestInfoFailure {
  ...
  protected Integer failureLinkNum;
  ...
  public Integer getFailureLinkNum() {
    return failureLinkNum;
  }

  public void setFailureLinkNum(Integer value) {
    this.failureLinkNum = value;
  }
