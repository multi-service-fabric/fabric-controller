...
public class ObjectFactory {
  ...
  private static final QName _DataConf_QNAME = new QName("http://fc.msf/common/config/type/data", "dataConf");
  ...
  @XmlElementDecl(namespace = "http://fc.msf/common/config/type/data", name = "dataConf")
