 ...
 *
 */
public class FcL3CpCreateScenario extends FcAbstractL3CpScenarioBase<L3CpRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(FcL3CpCreateScenario.class);
   ...
   *
   */
  public FcL3CpCreateScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      logger.methodStart();
      FcL3CpCreateRunner runner = new FcL3CpCreateRunner(request, requestBody);
