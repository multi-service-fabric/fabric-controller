 ...
 *
 */
public class FcL2CpCreateScenario extends FcAbstractL2CpScenarioBase<L2CpRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(FcL2CpCreateScenario.class);
   ...
   *
   */
  public FcL2CpCreateScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      logger.methodStart();
      FcL2CpCreateRunner runner = new FcL2CpCreateRunner(request, requestBody);
