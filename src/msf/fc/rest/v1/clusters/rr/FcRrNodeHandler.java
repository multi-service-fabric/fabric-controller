...
import msf.fc.node.nodes.rrs.FcRrNodeReadListScenario;
import msf.fc.node.nodes.rrs.FcRrNodeReadScenario;
 ...
 */
@Path("/v1/clusters")
public class FcRrNodeHandler extends AbstractRestHandler {

  private static final MsfLogger logger = MsfLogger.getInstance(FcRrNodeHandler.class);
  ...
  public Response readList(@PathParam("cluster_id") String clusterId, @QueryParam("format") String format,
    ...
    try {
      ...
      FcRrNodeReadListScenario scenario = new FcRrNodeReadListScenario(OperationType.NORMAL,
  ...
  public Response read(@PathParam("cluster_id") String clusterId, @PathParam("node_id") String nodeId,
    ...
    try {
      ...
      FcRrNodeReadScenario scenario = new FcRrNodeReadScenario(OperationType.NORMAL, SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
