...
public class L3SliceUpdateRequestBody implements RestRequestValidator {

  private static final MsfLogger logger = MsfLogger.getInstance(L3SliceUpdateRequestBody.class);
