...
public class CpTrafficRequest extends RestRequestBase {

  public CpTrafficRequest(String requestBody, String notificationAddress, String notificationPort, String sliceType,
