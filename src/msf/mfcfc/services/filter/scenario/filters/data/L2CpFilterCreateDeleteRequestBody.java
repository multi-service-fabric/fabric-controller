...
public class L2CpFilterCreateDeleteRequestBody extends AbstractFilterCreateDeleteRequestBody
    implements RestRequestValidator {

  private static final MsfLogger logger = MsfLogger.getInstance(L2CpFilterCreateDeleteRequestBody.class);
