...
public class PhysicalIfFilterCreateDeleteRequestBody extends AbstractFilterCreateDeleteRequestBody
    implements RestRequestValidator {

  private static final MsfLogger logger = MsfLogger.getInstance(PhysicalIfFilterCreateDeleteRequestBody.class);
