...
public class SpineNodeLagIfEntity {
  ...
  private SpineNodeInternalLagIfOptionEntity internalOption;
  ...
  public SpineNodeInternalLagIfOptionEntity getInternalOption() {
    return internalOption;
  }

  
  public void setInternalOption(SpineNodeInternalLagIfOptionEntity internalOption) {
