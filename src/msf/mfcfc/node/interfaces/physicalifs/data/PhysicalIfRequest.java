...
public class PhysicalIfRequest extends RestRequestBase {
  ...
  public PhysicalIfRequest(String requestBody, String notificationAddress, String notificationPort, String clusterId,
      String fabricType, String nodeId, String ifId, String format) {
