...
public class InterfaceChangeStateRequest extends RestRequestBase {
  ...
  public InterfaceChangeStateRequest(String requestBody, String notificationAddress, String notificationPort,
      String clusterId, String fabricType, String nodeId, String ifType, String ifId) {
  ...
  public InterfaceType getIfTypeEnum() {
    return InterfaceType.getEnumFromPluralMessage(ifType);
  }

  public void setIfTypeEnum(InterfaceType ifType) {
    this.ifType = ifType.getPluralMessage();
  }
