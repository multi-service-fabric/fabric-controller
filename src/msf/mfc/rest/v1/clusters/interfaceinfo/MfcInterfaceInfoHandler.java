...
package msf.mfc.rest.v1.clusters.interfaceinfo;
...
import msf.mfc.node.interfaces.MfcInterfaceReadListScenario;
 ...
 */
@Path("/v1/clusters")
public class MfcInterfaceInfoHandler extends AbstractRestHandler {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcInterfaceInfoHandler.class);
  ...
  public Response readList(@PathParam("cluster_id") String clusterId, @PathParam("fabric_type") String fabricType,
    ...
    try {
      ...
      MfcInterfaceReadListScenario scenario = new MfcInterfaceReadListScenario(OperationType.NORMAL,
