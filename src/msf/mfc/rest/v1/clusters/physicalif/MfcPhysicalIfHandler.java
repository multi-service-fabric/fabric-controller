...
package msf.mfc.rest.v1.clusters.physicalif;
...
import msf.mfc.node.interfaces.physicalifs.MfcPhysicalInterfaceReadListScenario;
import msf.mfc.node.interfaces.physicalifs.MfcPhysicalInterfaceReadScenario;
import msf.mfc.node.interfaces.physicalifs.MfcPhysicalInterfaceUpdateScenario;
 ...
 */
@Path("/v1/clusters")
public class MfcPhysicalIfHandler extends AbstractRestHandler {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcPhysicalIfHandler.class);
  ...
  public Response readList(@PathParam("cluster_id") String clusterId, @PathParam("fabric_type") String fabricType,
    ...
    try {
      ...
      MfcPhysicalInterfaceReadListScenario scenario = new MfcPhysicalInterfaceReadListScenario(OperationType.NORMAL,
  ...
  public Response read(@PathParam("cluster_id") String clusterId, @PathParam("fabric_type") String fabricType,
    ...
    try {
      ...
      MfcPhysicalInterfaceReadScenario scenario = new MfcPhysicalInterfaceReadScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
  ...
  public Response update(@PathParam("cluster_id") String clusterId, @PathParam("fabric_type") String fabricType,
    ...
    try {
      ...
      MfcPhysicalInterfaceUpdateScenario scenario = new MfcPhysicalInterfaceUpdateScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
