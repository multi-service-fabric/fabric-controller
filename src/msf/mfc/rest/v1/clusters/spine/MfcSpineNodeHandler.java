...
package msf.mfc.rest.v1.clusters.spine;
...
import msf.mfc.node.nodes.spines.MfcSpineNodeCreateScenario;
import msf.mfc.node.nodes.spines.MfcSpineNodeDeleteScenario;
import msf.mfc.node.nodes.spines.MfcSpineNodeReadListScenario;
import msf.mfc.node.nodes.spines.MfcSpineNodeReadScenario;
 ...
 */
@Path("/v1/clusters")
public class MfcSpineNodeHandler extends AbstractRestHandler {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcSpineNodeHandler.class);
  ...
  public Response create(@PathParam("cluster_id") String clusterId,
    ...
    try {
      ...
      MfcSpineNodeCreateScenario scenario = new MfcSpineNodeCreateScenario(OperationType.NORMAL,
  ...
  public Response readList(@PathParam("cluster_id") String clusterId, @QueryParam("format") String format,
    ...
    try {
      ...
      MfcSpineNodeReadListScenario scenario = new MfcSpineNodeReadListScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
  ...
  public Response read(@PathParam("cluster_id") String clusterId, @PathParam("node_id") String nodeId,
    ...
    try {
      ...
      MfcSpineNodeReadScenario scenario = new MfcSpineNodeReadScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
  ...
  public Response delete(@PathParam("cluster_id") String clusterId, @PathParam("node_id") String nodeId,
    ...
    try {
      ...
      MfcSpineNodeDeleteScenario scenario = new MfcSpineNodeDeleteScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
