...
package msf.mfc.rest.v1.clusters.leaf;
...
import msf.mfc.node.nodes.leafs.MfcLeafNodeCreateScenario;
import msf.mfc.node.nodes.leafs.MfcLeafNodeDeleteScenario;
import msf.mfc.node.nodes.leafs.MfcLeafNodeReadListScenario;
import msf.mfc.node.nodes.leafs.MfcLeafNodeReadScenario;
import msf.mfc.node.nodes.leafs.MfcLeafNodeUpdateScenario;
 ...
 */
@Path("/v1/clusters")
public class MfcLeafNodeHandler extends AbstractRestHandler {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcLeafNodeHandler.class);
  ...
  public Response create(@PathParam("cluster_id") String clusterId,
    ...
    try {
      ...
      MfcLeafNodeCreateScenario scenario = new MfcLeafNodeCreateScenario(OperationType.NORMAL,
  ...
  public Response readList(@PathParam("cluster_id") String clusterId, @QueryParam("format") String format,
    ...
    try {
      ...
      MfcLeafNodeReadListScenario scenario = new MfcLeafNodeReadListScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
  ...
  public Response read(@PathParam("cluster_id") String clusterId, @PathParam("node_id") String nodeId,
    ...
    try {
      ...
      MfcLeafNodeReadScenario scenario = new MfcLeafNodeReadScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
  ...
  public Response delete(@PathParam("cluster_id") String clusterId, @PathParam("node_id") String nodeId,
    ...
    try {
      ...
      MfcLeafNodeDeleteScenario scenario = new MfcLeafNodeDeleteScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
  ...
  public Response update(@PathParam("cluster_id") String clusterId, @PathParam("node_id") String nodeId,
    ...
    try {
      ...
      MfcLeafNodeUpdateScenario scenario = new MfcLeafNodeUpdateScenario(OperationType.NORMAL,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
