...
package msf.mfc.rest.v1.common.status;
...
import msf.mfc.core.status.scenario.MfcInternalSystemStatusNotifyScenario;
import msf.mfc.core.status.scenario.MfcSystemStatusReadScenario;
 ...
 */
@Path("/v1")
public class MfcSystemStatusHandler extends AbstractRestHandler {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcSystemStatusHandler.class);
  ...
  public Response read(@QueryParam("controller") @Encoded String controller,
    ...
    try {
      ...
      MfcSystemStatusReadScenario scenario = new MfcSystemStatusReadScenario(OperationType.PRIORITY,
  ...
  public Response notify(String requestBody) {
    try {
      ...
      MfcInternalSystemStatusNotifyScenario scenario = new MfcInternalSystemStatusNotifyScenario(OperationType.PRIORITY,
          SystemInterfaceType.EXTERNAL);
      RestResponseBase restResponseBase = scenario.execute(request);
      return createResponse(restResponseBase);
