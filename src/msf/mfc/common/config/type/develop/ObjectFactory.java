...
public class ObjectFactory {
  ...
  private static final QName _DevelopConf_QNAME = new QName("http://mfc.msf/common/config/type/develop", "developConf");
  ...
  @XmlElementDecl(namespace = "http://mfc.msf/common/config/type/develop", name = "developConf")
