 ...
 *
 */
public class MfcLagInterfaceCreateScenario extends MfcAbstractLagInterfaceScenarioBase<LagIfRequest> {

  private LagIfRequest request;
  private LagIfCreateRequestBody requestBody;

  private static final MsfLogger logger = MsfLogger.getInstance(MfcLagInterfaceCreateScenario.class);
   ...
   *
   */
  public MfcLagInterfaceCreateScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      ...
      MfcLagInterfaceCreateRunner createRunner = new MfcLagInterfaceCreateRunner(request, requestBody);
      execAsyncRunner(createRunner);
