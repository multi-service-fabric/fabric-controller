 ...
 *
 */
public class MfcClusterLinkInterfaceDeleteScenario
    extends MfcAbstractClusterLinkInterfaceScenarioBase<ClusterLinkIfRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcClusterLinkInterfaceDeleteScenario.class);
   ...
   *
   */
  public MfcClusterLinkInterfaceDeleteScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      ...
      MfcClusterLinkInterfaceDeleteRunner clusterLinkInterfaceDeleteRunner = new MfcClusterLinkInterfaceDeleteRunner(
          request);
