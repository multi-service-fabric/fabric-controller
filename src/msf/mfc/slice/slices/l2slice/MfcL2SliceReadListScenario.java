 ...
 *
 */
public class MfcL2SliceReadListScenario extends MfcAbstractL2SliceScenarioBase<L2SliceRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcL2SliceReadListScenario.class);
   ...
   *
   */
  public MfcL2SliceReadListScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    ...
    try {
      ...
      List<MfcL2Slice> l2SliceList = getL2SliceListFromDb(sessionWrapper);
  ...
  private List<MfcL2Slice> getL2SliceListFromDb(SessionWrapper sessionWrapper) throws MsfException {
    try {
  ...
  private RestResponseBase createResponse(List<MfcL2Slice> l2SliceList, RestFormatOption formatOption)
      throws MsfException {
    try {
  ...
  private L2SliceReadDetailListResponseBody createL2SliceDetailReadResponseBody(List<MfcL2Slice> l2SliceList)
      throws MsfException {
    try {
  ...
  private L2SliceReadListResponseBody createL2SliceReadResponseBody(List<MfcL2Slice> l2SliceList) {
    try {
      logger.methodStart(new String[] { "l2SliceList" }, new Object[] { l2SliceList });
