 ...
 *
 */
public class MfcL2SliceUpdateScenario extends MfcAbstractL2SliceScenarioBase<L2SliceRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcL2SliceUpdateScenario.class);
   ...
   *
   */
  public MfcL2SliceUpdateScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      logger.methodStart();
      MfcL2SliceUpdateRunner runner = new MfcL2SliceUpdateRunner(request, requestBody);
