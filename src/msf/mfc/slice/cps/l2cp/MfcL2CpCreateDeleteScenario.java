 ...
 *
 */
public class MfcL2CpCreateDeleteScenario extends MfcAbstractL2CpScenarioBase<L2CpRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcL2CpCreateDeleteScenario.class);
   ...
   *
   */
  public MfcL2CpCreateDeleteScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      logger.methodStart();
      MfcL2CpCreateDeleteRunner runner = new MfcL2CpCreateDeleteRunner(request, requestBody);
