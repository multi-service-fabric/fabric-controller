 ...
 *
 */
public class MfcL3CpUpdateScenario extends MfcAbstractL3CpScenarioBase<L3CpRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcL3CpUpdateScenario.class);
   ...
   *
   */
  public MfcL3CpUpdateScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      logger.methodStart();
      MfcL3CpUpdateRunner runner = new MfcL3CpUpdateRunner(request, requestBody);
