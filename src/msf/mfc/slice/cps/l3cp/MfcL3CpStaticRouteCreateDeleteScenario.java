 ...
 *
 */
public class MfcL3CpStaticRouteCreateDeleteScenario extends MfcAbstractL3CpScenarioBase<L3CpRequest> {

  private static final MsfLogger logger = MsfLogger.getInstance(MfcL3CpStaticRouteCreateDeleteScenario.class);
   ...
   *
   */
  public MfcL3CpStaticRouteCreateDeleteScenario(OperationType operationType, SystemInterfaceType systemInterfaceType) {
  ...
  protected RestResponseBase executeImpl() throws MsfException {
    try {
      logger.methodStart();
      MfcL3CpStaticRouteCreateDeleteRunner runner = new MfcL3CpStaticRouteCreateDeleteRunner(request, requestBody);
