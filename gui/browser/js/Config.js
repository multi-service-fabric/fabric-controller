...
// traffic: %
var trafficBoundary = [20, 40, 60, 80, 100];
...
//              // イベント受信サーバーに接続しない
//              NOT_CONNECT_TO_EVENT_SERVER: true,
//              // 初期データとしてダミーデータを使用する
//              USE_DUMMY_DATA: true,
//              // 障害通知ダイアログ抑止
...
//          lng: "zh_TW"
        ...
        EventServer: {
//              // オペレーション結果通知を受信しない
//              NOT_NOTIFY_OPERATIONS_DIALOG: true,
//              // コントローラ運用状態通知を受信しない
//              NOT_NOTIFY_STATUS_DIALOG: true,
//              // トラヒック情報通知を受信しない
//              NOT_NOTIFY_TRAFFIC_DIALOG: true,
//              // 障害情報通知を受信しない
//              NOT_NOTIFY_FAILURE_STATUS_DIALOG: true,
//              // サイレント故障通知を受信しない
//              NOT_NOTIFY_SILENT_FAILURE_DIALOG: true,
//              // 装置OSアップグレード通知を受信しない
//              NOT_NOTIFY_UPGRADE_OPERATIONS_DIALOG: true,
//              // コントローラ異常通知を受信しない
//              NOT_NOTIFY_CONTROLLER_STATUS_NOTIFICATION_FAILURE_DIALOG: true,
//              // コントローラログ通知を受信しない
//              NOT_NOTIFY_CONTROLLER_STATUS_NOTIFICATION_LOG_DIALOG: true
        }
    },
    //
    // MSFMainクラス設定
    ...
    MSFMain: {
        ...
        Polling: {
            ...
            OSUpgrade: {
                INTERVAL: 3000,
                TIMEOUT: 3000000 //1000ms * 60s * 5m * 10nodes
            },
            // 装置迂回
            SwitchDetour: {
                INTERVAL: 3000,
    ...
    Rest: {
        MFC: {
            HOST: "http://192.168.68.150:20001",
            EVENTSERVER: "http://192.168.68.150:8080",
