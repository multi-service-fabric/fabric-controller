...
//        },
        Polling: {
            ...
            getNotificationEvent: {
                operationName: "GET &lt;notification event&gt;",
                ConnectError: "Connection refused.",
                ConnectTimeout: "Connection timeout.",
                ResponseError: "{ResponseErrorMessage}",
                Output: "ログエリア"
        ...
        UpdateLagIF: {
             "update": {
                ConnectError: "REQUEST &lt;UPDATE lag IF&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;UPDATE lag IF&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;UPDATE lag IF&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
             },
             "check": {
                Success: "UPDATE &lt;lag IF&gt; has been completed. (LagIF ID = {lag_if_id})",
                ConnectError: "UPDATE &lt;lag IF&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "UPDATE &lt;lag IF&gt; has not been confirmed. Connection timeout.",
                ResponseError: "UPDATE &lt;lag IF&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "UPDATE &lt;lag IF&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "UPDATE &lt;lag IF&gt; was canceled by controller.",
                CheckTimeout: "UPDATE &lt;lag IF&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
             }
        },
        DeleteLagIF: {
        ...
        ModifyShutdown: {
            "modify": {
                Success: "MODIFY &lt;shutdown&gt; has been completed.",
                ConnectError: "MODIFY &lt;shutdown&gt; failed. Connection refused.",
                ConnectTimeout: "MODIFY &lt;shutdown&gt; failed. Connection timeout.",
                ResponseError: "MODIFY &lt;shutdown&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "MODIFY &lt;shutdown&gt; has been completed.",
                ConnectError: "MODIFY &lt;shutdown&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "MODIFY &lt;shutdown&gt; has not been confirmed. Connection timeout.",
                ResponseError: "MODIFY &lt;shutdown&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "MODIFY &lt;shutdown&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "MODIFY &lt;shutdown&gt; was cancelled by controller.",
                CheckTimeout: "MODIFY &lt;shutdown&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        AddSlice: {
        ...
        AddPhysicalIFACL: {
            "add": {
                ConnectError: "REQUEST &lt;ADD physical IF ACL&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;ADD physical IF ACL&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;ADD physical IF ACL&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "ADD &lt;physical IF ACL&gt; has been completed. (Term ID = {term_ids})",
                ConnectError: "ADD &lt;physical IF ACL&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "ADD &lt;physical IF ACL&gt; has not been confirmed. Connection timeout.",
                ResponseError: "ADD &lt;physical IF ACL&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "ADD &lt;physical IF ACL&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "ADD &lt;physical IF ACL&gt; was canceled by controller.",
                CheckTimeout: "ADD &lt;physical IF ACL&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        DeletePhysicalIFACL: {
            "add": {
                ConnectError: "REQUEST &lt;DELETE physical IF ACL&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;DELETE physical IF ACL&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;DELETE physical IF ACL&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "DELETE &lt;physical IF ACL&gt; has been completed.",
                ConnectError: "DELETE &lt;physical IF ACL&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "DELETE &lt;physical IF ACL&gt; has not been confirmed. Connection timeout.",
                ResponseError: "DELETE &lt;physical IF ACL&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "DELETE &lt;physical IF ACL&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "DELETE &lt;physical IF ACL&gt; was canceled by controller.",
                CheckTimeout: "DELETE &lt;physical IF ACL&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        AddLagIFACL: {
            "add": {
                ConnectError: "REQUEST &lt;ADD lag IF ACL&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;ADD lag IF ACL&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;ADD lag IF ACL&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "ADD &lt;lag IF ACL&gt; has been completed. (Term ID = {term_ids})",
                ConnectError: "ADD &lt;lag IF ACL&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "ADD &lt;lag IF ACL&gt; has not been confirmed. Connection timeout.",
                ResponseError: "ADD &lt;lag IF ACL&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "ADD &lt;lag IF ACL&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "ADD &lt;lag IF ACL&gt; was canceled by controller.",
                CheckTimeout: "ADD &lt;lag IF ACL&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        DeleteLagIFACL: {
            "add": {
                ConnectError: "REQUEST &lt;DELETE lag IF ACL&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;DELETE lag IF ACL&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;DELETE lag IF ACL&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "DELETE &lt;lag IF ACL&gt; has been completed.",
                ConnectError: "DELETE &lt;lag IF ACL&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "DELETE &lt;lag IF ACL&gt; has not been confirmed. Connection timeout.",
                ResponseError: "DELETE &lt;lag IF ACL&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "DELETE &lt;lag IF ACL&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "DELETE &lt;lag IF ACL&gt; was canceled by controller.",
                CheckTimeout: "DELETE &lt;lag IF ACL&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        OSUpgrade: {
            "upgrade": {
                Success: "REQUEST &lt;OS Upgrade&gt; has been completed. (Cluster = #{cluster_id})",
                ConnectError: "REQUEST &lt;OS Upgrade&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;OS Upgrade&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;OS Upgrade&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "cancel": {
                Success: "REQUEST &lt;OS Upgrade Cancel&gt; has been completed. (Cluster = #{cluster_id})",
                ConnectError: "REQUEST &lt;OS Upgrade Cancel&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;OS Upgrade Cancel&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;OS Upgrade Cancel&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "Update Complete!!</br>&nbsp;&nbsp;{nodes_info}",
                ConnectError: "Update has not been confirmed. Connection refused.",
                ConnectTimeout: "Update has not been confirmed. Connection timeout.",
                ResponseError: "Update has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "Update failed!!</br>&nbsp;&nbsp;{nodes_info}</br>{ResponseErrorMessage}",
                CheckCanceled: "Update was canceled by controller.",
                CheckTimeout: "Update has not been confirmed. Timeout.",
                Output: "アップグレードパネル"
            }
        },
        SwitchDetour: {
            "detour": {
                Success: "REQUEST &lt;SWITCH Detour&gt; has been completed.",
                ConnectError: "REQUEST &lt;SWITCH Detour&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;SWITCH Detour&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;SWITCH Detour&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "SWITCH &lt;Detour&gt; has been completed. ",
                ConnectError: "SWITCH &lt;Detour&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "SWITCH &lt;Detour&gt; has not been confirmed. Connection timeout.",
                ResponseError: "SWITCH &lt;Detour&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "SWITCH &lt;Detour&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "SWITCH &lt;Detour&gt; was canceled by controller.",
                CheckTimeout: "SWITCH &lt;Detour&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        SwitchPriority: {
            "add": {
                Success: "REQUEST &lt;ADD Priority&gt; has been completed.",
                ConnectError: "REQUEST &lt;ADD Priority&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;ADD Priority&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;ADD Priority&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "delete": {
                Success: "REQUEST &lt;DELETE Priority&gt; has been completed.",
                ConnectError: "REQUEST &lt;DELETE Priority&gt; failed. Connection refused.",
                ConnectTimeout: "REQUEST &lt;DELETE Priority&gt; failed. Connection timeout.",
                ResponseError: "REQUEST &lt;DELETE Priority&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "SWITCH &lt;Priority&gt; has been completed. ",
                ConnectError: "SWITCH &lt;Priority&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "SWITCH &lt;Priority&gt; has not been confirmed. Connection timeout.",
                ResponseError: "SWITCH &lt;Priority&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "SWITCH &lt;Priority&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "SWITCH &lt;Priority&gt; was canceled by controller.",
                CheckTimeout: "SWITCH &lt;Priority&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        },
        LinkCost: {
            "modify": {
                Success: "MODIFY &lt;Link cost&gt; has been completed.",
                ConnectError: "MODIFY &lt;Link cost&gt; failed. Connection refused.",
                ConnectTimeout: "MODIFY &lt;Link cost&gt; failed. Connection timeout.",
                ResponseError: "MODIFY &lt;Link cost&gt; failed. {ResponseErrorMessage}",
                Output: "登録系共通パネル"
            },
            "check": {
                Success: "LINK &lt;Cost modify&gt; has been completed. ",
                ConnectError: "LINK &lt;Cost modify&gt; has not been confirmed. Connection refused.",
                ConnectTimeout: "LINK &lt;Cost modify&gt; has not been confirmed. Connection timeout.",
                ResponseError: "LINK &lt;Cost modify&gt; has not been confirmed. {ResponseErrorMessage}",
                CheckFailed: "LINK &lt;Cost modify&gt; failed. {ResponseErrorMessage}",
                CheckCanceled: "LINK &lt;Cost modify&gt; was canceled by controller.",
                CheckTimeout: "LINK &lt;Cost modify&gt; has not been confirmed. Timeout.",
                Output: "登録系共通パネル"
            }
        }
